...
L'objectif de ce projet est d'exploiter certaines failles du top 10 d'OWASP par la découverte et la mise en place du site de OWASP Juice Shop, une boutique en ligne volontairement vulnérable qui permet d'apprendre l'exploitation de ces failles à travers une série de défis pratiques.
